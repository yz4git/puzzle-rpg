...
if '## SFC Visual Reconstruction Pass 15' not in p:
    ...
    for old in replacements:
        p = p.replace(old, 'The housing matches the existing regional board selector specificity so its scene frame and preview highlight reliably win the cascade in Safari/Chrome; puzzle logic and timing are unchanged.')
