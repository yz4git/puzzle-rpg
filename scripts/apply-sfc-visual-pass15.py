...
if '## SFC Visual Reconstruction Pass 15' not in p:
    ...
    for old in [
        ...
        p = p.replace(old, 'The housing uses standalone CSS Module presentation classes so its scene frame and preview highlight remain deterministic in Safari/Chrome after bundling; puzzle logic and timing are unchanged.')
