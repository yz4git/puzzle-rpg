...
function bossPhaseBonus(enemyRatio: number) {
...
export default function PuzzleRPGClusterBreak() {
  ...
  const enemyRatio = maxEnemyHp > 0 ? enemyHp / maxEnemyHp : 1;
  ...
  async function clearTile(seed: Tile) {
    ...
    const currentIntent = enemyIntent(stage, enemyStep, currentStage, nextPlayerHp, enemyRatio);
    let hpDamage = 0;
    let blocked = 0;
